...
export class StSketchPoint extends StGeometic2D {
	static copyObj(p: StSketchPoint) {
...
export class StSketchRect extends StSketchPolygon {
	...
	static buildRectByStartPoint(p0: StSketchPoint, width:number, height: number) {
	...
	static formulatePoints(points: Array<StSketchPoint>) {
